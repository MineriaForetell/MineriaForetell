...
public class assignWork extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            mineId = Integer.parseInt(request.getParameter("mineId").toString());
            System.out.println("mineId:"+mineId);
            hs.setAttribute("mineId", mineId);

            Criteria cr = ss.createCriteria(ProjectDetails.class);
            cr.add(Restrictions.eq("mineId", mineId));//need to be dynamic
            ...
            System.out.println("assignWork.java:"+e.getMessage());
