 ...
 * @author raxton
 */
public class analyzeFiles extends HttpServlet {
...
//            int mineId = Integer.parseInt(request.getSession().getAttribute("mineId").toString());
            int mineId = 1;
            ...
            if (processReq.equals("starthadoop")) {
                ...
                //Path must have correct value
                String startProcess = "nohup sh -x /home/raxton/uploads/"+mineId+".sh  > temp.log  2>&1 &";
