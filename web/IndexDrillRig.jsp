            ...
            <div class="container">
                <div class="row"> 
                    ...
                    <div class="col-md-8 contact-info">
                        ...
                        <div id="navthing" >
                            <h4 class="pull-right whitefontcolor">Drill Rig Operator:<a href="#" id="loginform"> <%=ui.getUserFirstName()%></a></h4>
    ...
    <div class="container">
        <div class="row">
            <div class="tp-ft-section-second  ">
                <div class="col-md-12 font-fade" >            
                    <div class="col-md-2 font-fade"  >

                    </div>
                    <a href="viewTask?page=ViewTask" >
                        <div class="col-md-4 font-fade" >
                            <div class="menudivs">
                                <span>View Task</span>
                            </div>
                        </div>
                    </a>
                    <a href="viewTask?page=uploadFile.jsp" >
                        <div class="col-md-4 font-fade" id="servicesection">
                            <div class="menudivs">
