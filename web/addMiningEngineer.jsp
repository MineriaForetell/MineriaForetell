        ...
        <div class="row">
            <div class="col-md-12 fontbigger" >            
                ...
                <div class="col-md-8 fontbigger message-mail addUserForm ">
                    <form action="addMiningEngineer" id="registration" method="post"  onsubmit="return(formValidation());" name="frm">
