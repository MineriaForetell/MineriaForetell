<%-- 
    ...
    Created on : 8 Jan, 2016, 10:53:40 PM
    Author     : raxton
--%>
                ...
                <div class="container"> 
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="activeclassic"><a href="ProjectList?page=ViewProject">View Project</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12" >            
            ...
            <div class="col-md-8 message-mail addUserForm ">
                <%
                    if (request.getAttribute("projDet") != null) {
                        ProjectDetails pd = (ProjectDetails) request.getAttribute("projDet");
                %>
                <center><table border="1">
                        ...
                        <tr>
                            <td class="reporttext whitefontcolor">Due Date</td>
                            <td class="reporttext whitefontcolor"><%= pd.getDueDate()%> </td>
                        </tr>
                        <tr>
                            <td class="reporttext whitefontcolor">Points</td>
                            <td class="reporttext whitefontcolor"><%= pd.getPoints()%> </td>
                        </tr>
                        <tr>
                            <td class="reporttext whitefontcolor">Task</td>
                            <td class="reporttext whitefontcolor"><%= pd.getTasks()%> </td>
                        </tr>
                    </table>
                    ...
                    %>
                    <a href="assignWork.jsp"><input type="button" value="Assign Task" class="message-mail sub-btn"></a>
                </center>
            </div>
