                ...
                <div class="container"> 
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li class="activeclassic"><a href="ProjectList?page=viewTask">View Tasks</a></li>
                            <li><a href="ProjectList?page=uploadFile">Upload File</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12" >            
                ...
                <div class="col-md-8 message-mail addUserForm ">
                        ...
                        <table>
                            <tr>
                                <td class="reporttext whitefontcolor">Depth </td>
                                <td>:</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="reporttext whitefontcolor">Mining Engineer </td>
                                <td>:</td>
                            </tr>
                        </table>
                        <br>
                    ...
                    <table border="3" class="table-bordered table-responsive padding" style="width: 100%;text-align: left">
                        <tr>
                            <th>Point id</th>
                            <th>Location</th>
                        </tr>
                        <tr>
                            <td class="reporttext whitefontcolor">Item-1</td>
                            <td class="reporttext whitefontcolor">Item-2</td>
                        </tr>
                    </table>
